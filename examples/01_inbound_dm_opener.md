...
**Formatting reminder:** Every option MUST have a blank line between the greeting and the next paragraph. Every option MUST include 1-3 emojis (placed at end of sentences/paragraphs, never at the start, never stacked). See voice file for approved palette.
...
- Option B opens with a 💡 reframe (it's not "struggling to close", it's a structure problem), more confrontational, very Marco
...
> Hey [name] 👋
>
> Before I send anything, two quick questions so I can tell you what's relevant 🎯
>
